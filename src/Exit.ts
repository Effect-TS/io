 ...
 * @category models
 */
export interface Failure<E, A> extends Omit<Effect.Effect<never, E, A>, "pipe">, Pipeable<Failure<E, A>> {
 ...
 * @category models
 */
export interface Success<E, A> extends Omit<Effect.Effect<never, E, A>, "pipe">, Pipeable<Success<E, A>> {
