...
describe.concurrent("Effect", () => {
    ...
    Effect.gen(function*($) {
      ...
      const fiber = yield* $(
        Effect.asyncEffect<never, unknown, unknown, never, unknown, unknown>((_) =>
          ...
          Effect.acquireUseRelease(Deferred.succeed(acquire, void 0), {
            use: () => Effect.never,
  ...
  it.effect("race in daemon is executed", () =>
    Effect.gen(function*($) {
      ...
      const loser1 = Effect.acquireUseRelease(Deferred.succeed(latch1, void 0), {
        use: () => Effect.never,
        release: () => Deferred.succeed(deferred1, void 0)
      })
      const loser2 = Effect.acquireUseRelease(Deferred.succeed(latch2, void 0), {
        use: () => Effect.never,
  ...
  it.effect("raceFirst interrupts loser on success", () =>
    Effect.gen(function*($) {
      ...
      const loser = Effect.acquireUseRelease(Deferred.succeed(deferred, void 0), {
        use: () => Effect.never,
